 ...
 * 
 */
@WebServiceClient(name = "UserService", targetNamespace = "http://xmlns.oracle.com/Primavera/P6/WS/User/V1", wsdlLocation = "http://192.168.14.217:8206/p6ws/services/UserService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName USERSERVICE_QNAME = new QName("http://xmlns.oracle.com/Primavera/P6/WS/User/V1", "UserService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://192.168.14.217:8206/p6ws/services/UserService?wsdl");
    ...
    public UserPortType getUserPort() {
        return super.getPort(new QName("http://xmlns.oracle.com/Primavera/P6/WS/User/V1", "UserPort"), UserPortType.class);
    }
    ...
    public UserPortType getUserPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://xmlns.oracle.com/Primavera/P6/WS/User/V1", "UserPort"), UserPortType.class, features);
    }
