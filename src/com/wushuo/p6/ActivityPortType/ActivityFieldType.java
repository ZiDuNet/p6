 ...
 *     &lt;enumeration value="PerformancePercentCompleteByLaborUnits"/>
 ...
 *     &lt;enumeration value="ScopePercentComplete"/>
 ...
 *     &lt;enumeration value="TaskStatusCompletion"/>
 *     &lt;enumeration value="TaskStatusDates"/>
 *     &lt;enumeration value="TaskStatusIndicator"/>
 ...
 *     &lt;enumeration value="WBSNamePath"/>
 *     &lt;enumeration value="WBSObjectId"/>
 *     &lt;enumeration value="WBSPath"/>
 *     &lt;enumeration value="WorkPackageId"/>
 *     &lt;enumeration value="WorkPackageName"/>
 *   &lt;/restriction>
 * &lt;/simpleType>
 * </pre>
 * 
...
public enum ActivityFieldType {
    ...
    @XmlEnumValue("PerformancePercentCompleteByLaborUnits")
    PERFORMANCE_PERCENT_COMPLETE_BY_LABOR_UNITS("PerformancePercentCompleteByLaborUnits"),
    ...
    @XmlEnumValue("PostRespCriticalityIndex")
    POST_RESP_CRITICALITY_INDEX("PostRespCriticalityIndex"),
    ...
    @XmlEnumValue("PreRespCriticalityIndex")
    PRE_RESP_CRITICALITY_INDEX("PreRespCriticalityIndex"),
    ...
    @XmlEnumValue("ScopePercentComplete")
    SCOPE_PERCENT_COMPLETE("ScopePercentComplete"),
    ...
    @XmlEnumValue("TaskStatusCompletion")
    TASK_STATUS_COMPLETION("TaskStatusCompletion"),
    @XmlEnumValue("TaskStatusDates")
    TASK_STATUS_DATES("TaskStatusDates"),
    @XmlEnumValue("TaskStatusIndicator")
    TASK_STATUS_INDICATOR("TaskStatusIndicator"),
    ...
    WBS_NAME("WBSName"),
    @XmlEnumValue("WBSNamePath")
    WBS_NAME_PATH("WBSNamePath"),
    @XmlEnumValue("WBSObjectId")
    WBS_OBJECT_ID("WBSObjectId"),
    @XmlEnumValue("WBSPath")
    WBS_PATH("WBSPath"),
    @XmlEnumValue("WorkPackageId")
    WORK_PACKAGE_ID("WorkPackageId"),
    @XmlEnumValue("WorkPackageName")
