 ...
 * generated in the com.wushuo.p6.ActivityPortType package. 
...
public class ObjectFactory {
    ...
    private final static QName _ActivityPostRespCriticalityIndex_QNAME = new QName("http://xmlns.oracle.com/Primavera/P6/WS/Activity/V1", "PostRespCriticalityIndex");
    ...
    private final static QName _ActivityPreRespCriticalityIndex_QNAME = new QName("http://xmlns.oracle.com/Primavera/P6/WS/Activity/V1", "PreRespCriticalityIndex");
    ...
    private final static QName _ActivityPerformancePercentCompleteByLaborUnits_QNAME = new QName("http://xmlns.oracle.com/Primavera/P6/WS/Activity/V1", "PerformancePercentCompleteByLaborUnits");
    ...
    private final static QName _ActivityTaskStatusIndicator_QNAME = new QName("http://xmlns.oracle.com/Primavera/P6/WS/Activity/V1", "TaskStatusIndicator");
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.wushuo.p6.ActivityPortType
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://xmlns.oracle.com/Primavera/P6/WS/Activity/V1", name = "PostRespCriticalityIndex", scope = Activity.class)
    public JAXBElement<Double> createActivityPostRespCriticalityIndex(Double value) {
        return new JAXBElement<Double>(_ActivityPostRespCriticalityIndex_QNAME, Double.class, Activity.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://xmlns.oracle.com/Primavera/P6/WS/Activity/V1", name = "PreRespCriticalityIndex", scope = Activity.class)
    public JAXBElement<Double> createActivityPreRespCriticalityIndex(Double value) {
        return new JAXBElement<Double>(_ActivityPreRespCriticalityIndex_QNAME, Double.class, Activity.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://xmlns.oracle.com/Primavera/P6/WS/Activity/V1", name = "PerformancePercentCompleteByLaborUnits", scope = Activity.class)
    public JAXBElement<Double> createActivityPerformancePercentCompleteByLaborUnits(Double value) {
        return new JAXBElement<Double>(_ActivityPerformancePercentCompleteByLaborUnits_QNAME, Double.class, Activity.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://xmlns.oracle.com/Primavera/P6/WS/Activity/V1", name = "TaskStatusIndicator", scope = Activity.class)
    public JAXBElement<Boolean> createActivityTaskStatusIndicator(Boolean value) {
        return new JAXBElement<Boolean>(_ActivityTaskStatusIndicator_QNAME, Boolean.class, Activity.class, value);
    }
